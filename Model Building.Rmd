...
The reference cell coding approach for creating dummy variables for smoking category ensures that the linearity assumption is met.  The above plots do not show any overt change in variance with increasing $\hat{Y}$; suggesting that the homoscedasticity assumption is met.  Furthermore the residuals do not seem to be asymmetrically distributed, skewed, or multi-modal in any way; suggesting that the normality assumption is likely met.
