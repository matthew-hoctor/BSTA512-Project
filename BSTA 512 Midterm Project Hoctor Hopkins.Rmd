...
This analysis has two primary aims: (1) to evaluate the effects of BMI on the relationship between maternal smoking and birth weight; and (2) to develop a model to predict birthweight based on factors such as smoking status, maternal BMI, and age.
