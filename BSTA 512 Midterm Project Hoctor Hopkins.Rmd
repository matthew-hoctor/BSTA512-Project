...
CHDS <- CHDS %>%
  mutate(
    SMK_cat = case_when(
      ...
      mnocig > 20 ~ "3"),
    SMK1 = ifelse(SMK_cat == "1", 1, 0),
    SMK2 = ifelse(SMK_cat == "2", 1, 0),
    SMK3 = ifelse(SMK_cat == "3", 1, 0),
