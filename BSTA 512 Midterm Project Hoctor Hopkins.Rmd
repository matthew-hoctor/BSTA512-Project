...
**Maternal Pre-Pregnancy BMI** There was no evidence to support the inclusion of maternal age as an effect modifier (P > 0.10 for all three interaction terms; see Output A.9), but there was support for the inclusion of BMI as a confounder for the relationship between SDP and birth weight (>10% change in one slope term for smoking with inclusion of BMI; see Output A.10).
